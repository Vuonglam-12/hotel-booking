...
<div class="min-h-screen flex items-center justify-center py-12 px-4"
    ...
    <div class="w-full max-w-md">
        ...
        <div class="bg-white rounded-2xl p-8 shadow-lg border border-[#EAF3FF]">
            ...
            {{-- Google OAuth --}}
            <button onclick="registerWithGoogle()" class="btn-social mb-4">
...
function registerWithGoogle() {
    alert('🚧 Tính năng đăng ký Google đang phát triển!\nVui lòng đăng ký bằng Email hoặc SDT trong thời gian này.');
}
